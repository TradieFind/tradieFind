...
reservation2 = Reservation.create(user_id: 4, location: "Gordon", trade_name: "Carpenter", request_time: "1100", comments: "Leaky roof", job_status: "Completed")
reservation3 = Reservation.create(user_id: 6, location: "Strathfield", trade_name: "Grave Digger", request_time: "0800", comments: "Bury wife", job_status: "Pending")
...
reservation5 = Reservation.create(user_id: 3, location: "Milsons Point", trade_name: "Carpenter", request_time: "1202", comments: "Sesh brah", job_status: "Completed")
...
reservation8 = Reservation.create(user_id: 12, location: "Penrith", trade_name: "Mechanic", request_time: "1202", comments: "Fix lights", job_status: "Pending")
reservation9 = Reservation.create(user_id: 4, location: "Glenbrook", trade_name: "Carpenter", request_time: "1202", comments: "cut some wood", job_status: "Completed")
...
reservation12 = Reservation.create(user_id: 14, location: "Hornsby", trade_name: "Locksmith", request_time: "1202", comments: "Open door", job_status: "Pending")
reservation13 = Reservation.create(user_id: 15, location: "Hornsby", trade_name: "Locksmith", request_time: "1202", comments: "Close door", job_status: "Pending")
reservation14 = Reservation.create(user_id: 12, location: "Lane Cove", trade_name: "Carpenter", request_time: "1202", comments: "Cut some more wood", job_status: "Pending")
